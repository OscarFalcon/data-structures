...
/**
	...
	multiplication -
		h(k) = [a*k mod 2^w] >> (w - r)
		a is a random odd number not close to a power of two
		w is the bit size of the machine
		m = 2^r so.... logbase2(m) = r
	universal hash function 
		h(k) = [(a*k + b)mod p]mod m
		a and b are random numbers {0..p-1}
		p is a prime larger than the universe 
		mod m ensures, well, you get a number between 0 and m-1
**/ 
